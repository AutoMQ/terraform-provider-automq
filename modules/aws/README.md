...
| <a name="input_automq_byoc_ami_id"></a> [automq\_byoc\_ami\_id](#input\_automq\_byoc\_ami\_id) | When obtaining ami id from non-cloud market, manually specify ami id. | `string` | n/a |    no    |
| <a name="input_specified_by_the_marketplace"></a> [specified\_by\_the\_marketplace](#input\_specified\_by\_the\_marketplace) | Specifies the switch to obtain ami id from the cloud market. If true, it means to obtain the specified version of ami id through the cloud market. Otherwise, it needs to be specified manually. | `bool` | `true` |    no    |
