...
type DeployProfileModel struct {
	...
	OpsBucket        *BucketProfileModel        `tfsdk:"ops_bucket"`
	DataBuckets      []BucketProfileDetailModel `tfsdk:"data_buckets"`
...
// BucketProfileDetailModel describes the bucket profile detail data model.
...
func FlattenDeployProfileResource(profile *client.DeployProfileVO, data *DeployProfileModel) {
	...
	if profile.OpsBucket != nil {
		data.OpsBucket = &BucketProfileModel{
